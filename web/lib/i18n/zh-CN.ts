const zhCN = {
  ...
  securitySettings: {
    ...
    changeUsernameDesc: '修改登录账号的用户名',
    newUsername: '新用户名',
    newUsernamePlaceholder: '至少 2 个字符',
    usernameTooShort: '用户名长度至少 2 个字符',
    usernamePassword: '当前密码',
    usernamePasswordPlaceholder: '输入密码以确认身份',
    usernameSuccess: '用户名修改成功，即将退出登录',
    usernameError: '用户名修改失败',
    submitUsername: '修改用户名',
    changingUsername: '修改中...',
  ...
  llmSettings: {
    ...
    anthropicDesc: 'Claude 4, Claude 3.5 等',
