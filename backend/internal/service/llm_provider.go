...
//
//  3. ExtractAgent — used after STT produces a transcript. It extracts structured data
//     (title, summary, action_items, memories) from the raw transcript text.
//
//  4. SummarizeTitle — generates a short title for a chat session based on the first exchange.
